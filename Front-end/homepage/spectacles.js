...
<View>
  ...
  <Text style={{fontFamily:"Inter-Black",fontSize:24,color:"#ececec",alignItems:"center",marginTop:-20,marginLeft:150}}> Spectacles </Text>
...
<View>
   ...
   <FlatList 
       data={spectacles}  renderItem={({item})=><View>
